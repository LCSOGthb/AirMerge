...
import { Client, Integration, Span, TransactionSource } from '@sentry/core';
 ...
 */
export declare function processResolvedRoutes(resolvedRoutes: RouteObject[], parentRoute?: RouteObject, currentLocation?: Location | null): void;
/**
 ...
 */
export declare function handleExistingNavigationSpan(activeSpan: Span, spanJson: ReturnType<typeof spanToJSON>, name: string, source: TransactionSource, isLikelyLazyRoute: boolean): void;
/**
 * Creates a new navigation span
 */
export declare function createNewNavigationSpan(client: Client, name: string, source: TransactionSource, version: string, isLikelyLazyRoute: boolean): void;
export {};
